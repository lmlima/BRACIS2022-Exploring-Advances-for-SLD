...
def cnfg():
    ...
    # Dataset variables
    _folder = 5 # 5
    _base_path = "/home/leandro/Documentos/doutorado/dados/pad-ufes-20/extraido/"
    ...
    _save_path = "results"
    _save_folder = str(_save_path) + "/" + str(_comb_method) + "_" + _model_name + "_reducer_" + str(_neurons_reducer_block) + "_fold_" + str(_folder) + "_" + str(time.time()).replace('.', '')
